...
public class DashboardCoordinateurActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dashboard_coordinateur_activity);

        Toolbar toolbar = (Toolbar) findViewById(R.id.idToolbarDashboardCoordinateur);
        ...
        BottomNavigationView bottomNavigationView = (BottomNavigationView)
                findViewById(R.id.idBottomNavigationCoordinateur);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                transaction.replace(R.id.idFrameLayoutCoordinateur, selectedFragment).addToBackStack("tag");
                transaction.commit();
                return true;
            }
        });
        ...
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.idFrameLayoutCoordinateur, fragmentCoordinateurAcceuil);
        transaction.commit();
    }
}
