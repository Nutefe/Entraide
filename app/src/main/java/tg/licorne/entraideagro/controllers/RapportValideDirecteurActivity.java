...
public class RapportValideDirecteurActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (response != null){
                                ...
                                recyclerView.addItemDecoration(new DriverItemDecoration(RapportValideDirecteurActivity.this, DriverItemDecoration.VERTICAL_LIST, 0));
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.idFloatingActionButtonRapportValide:
                Intent intent = new Intent(RapportValideDirecteurActivity.this, EditeRapportDirecteur.class);
