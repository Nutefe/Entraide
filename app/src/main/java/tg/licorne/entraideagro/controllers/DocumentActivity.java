...
public class DocumentActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
                            ...
                            if (response != null){
                                ...
                                for (int i = 0; i<resSucces.length(); i++){
                                    ...
                                    Documents documents = new Documents(
                                            ...
                                            docObjet.getString("type_fichier")
                                    );
                                    documentsList.add(documents);
                                }
                                documentAdapter = new DocumentAdapter(documentsList);
                                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(DocumentActivity.this);
                                recyclerView.setLayoutManager(layoutManager);
                                recyclerView.setItemAnimator(new DefaultItemAnimator());
                                recyclerView.addItemDecoration(new DriverItemDecoration(DocumentActivity.this, DriverItemDecoration.VERTICAL_LIST, 0));
