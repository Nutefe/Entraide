...
import tg.licorne.entraideagro.fragment.FragmentPartenaireProfile;
import tg.licorne.entraideagro.fragment.FragmentPartenaireRapport;
...
public class DashboardPartenaireActivity extends AppCompatActivity {
    private String token;
    private int id_role;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dashboard_partenaire_activity);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.idItemRapportCoor:
                        selectedFragment = new FragmentPartenaireRapport();
                    ...
                    case R.id.idItemProfileCoor:
                        selectedFragment = new FragmentPartenaireProfile();
        ...
        FragmentPromoteurFerme fragmentAcceuilDirecteur = new FragmentPromoteurFerme();
        Bundle bundleFerme = new Bundle();
        bundleFerme.putString("TOKEN", token);
        bundleFerme.putInt("ID_ROLE", id_role);
        fragmentAcceuilDirecteur.setArguments(bundleFerme);
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
