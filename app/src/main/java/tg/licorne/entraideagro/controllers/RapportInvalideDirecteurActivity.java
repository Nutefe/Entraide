...
public class RapportInvalideDirecteurActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (response != null){
                                ...
                                recyclerView.addItemDecoration(new DriverItemDecoration(RapportInvalideDirecteurActivity.this, DriverItemDecoration.VERTICAL_LIST, 0));
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.idFloatingActionButtonRapportInvalide:
                Intent intent = new Intent(RapportInvalideDirecteurActivity.this, EditeRapportDirecteur.class);
