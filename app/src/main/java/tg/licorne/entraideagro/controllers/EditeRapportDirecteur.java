...
public class EditeRapportDirecteur extends AppCompatActivity {
    private File file;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        permisCamera = ActivityCompat.checkSelfPermission(EditeRapportDirecteur.this, Manifest.permission.CAMERA);
        permissionCheck = ContextCompat.checkSelfPermission(EditeRapportDirecteur.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        ...
        StringRequest stringDetailUser = new StringRequest(Request.Method.GET, urlDetail,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //Toast.makeText(EditeRapportDirecteur.this, error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void loadSpinnerTypeAgent(){
        ...
        agentList.add(new TypeAgent(5, "Partenaire"));
        ...
        agents.add("Partenaire");
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(EditeRapportDirecteur.this, android.R.layout.simple_spinner_item, agents);
    ...
    private void loadSpinnerActivite(){
        ...
        //Toast.makeText(EditeRapportDirecteur.this, String.valueOf(id_type_agent), Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (response != null){
                                ...
                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(EditeRapportDirecteur.this, android.R.layout.simple_spinner_item, activite);
                                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                                ...
                                spinnerActiviter.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                    ...
                                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                        ...
                                        Toast.makeText(EditeRapportDirecteur.this, String.valueOf(id_activite), Toast.LENGTH_SHORT).show();
                                    }
                                    @Override
                                    public void onNothingSelected(AdapterView<?> adapterView) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (response != null){
                                JSONObject obj = new JSONObject(response);
                                progressDialog.hide();
                                Toast.makeText(EditeRapportDirecteur.this, "Envoyer avec succes", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private void invokeVideoCamera() throws IOException {
        ...
        if (takeVideoIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (videoFile != null) {
                videoURI = FileProvider.getUriForFile(EditeRapportDirecteur.this,
    ...
    private void invokeCamera() throws IOException {
        ...
        if (intent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                photoURI = FileProvider.getUriForFile(EditeRapportDirecteur.this,
                        BuildConfig.APPLICATION_ID + ".provider",
                        createImageFile());
            ...
            case REQUEST_VIDEO_CAPTURE:
                if (resultCode == RESULT_OK){
                    ...
                    try{
                        ...
                        Toast.makeText(EditeRapportDirecteur.this, "failed to record video", Toast.LENGTH_SHORT).show();
            ...
            case PICK_IMAGE_MULTIPLE:
                if (resultCode == Activity.RESULT_OK){
                    ...
                    if (data!= null){
                        ...
                        Log.i("path", FileUtil.getPath(EditeRapportDirecteur.this, uriFileTake));
    ...
    public interface ApiConfig{
        ...
        Call<EditeRapportActivity.MyResponse> uploadFile(
    ...
    public static class AppConf{
        ...
        public static Retrofit getRetrofit(){
            return new Retrofit.Builder()
                    .client(client)
                    .baseUrl(EditeRapportDirecteur.AppConf.BASE_URL)
    ...
    private void uploadFile(){
        ...
        for (Uri p : mArrayUri){
            File file1 = new File(FileUtil.getPath(EditeRapportDirecteur.this, p));
            file = file1;
            if (file1.exists()){
        ...
        EditeRapportActivity.ApiConfig getResponse = EditeRapportActivity.AppConf.getRetrofit().create(EditeRapportActivity.ApiConfig.class);
        Call<EditeRapportActivity.MyResponse> call = getResponse.uploadFile( objetRap, contenuRap, activite_id, sender_id, zone_id, reciever_id, parts);
        call.enqueue(new Callback<EditeRapportActivity.MyResponse>() {

            @Override
            public void onResponse(Call<EditeRapportActivity.MyResponse> call, retrofit2.Response<EditeRapportActivity.MyResponse> response) {
            ...
            @Override
            public void onFailure(Call<EditeRapportActivity.MyResponse> call, Throwable t) {
