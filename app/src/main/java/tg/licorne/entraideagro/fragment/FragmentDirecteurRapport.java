...
import tg.licorne.entraideagro.controllers.EditeRapportDirecteur;
import tg.licorne.entraideagro.helper.DriverItemDecoration;
import tg.licorne.entraideagro.model.Rapports;

public class FragmentDirecteurRapport extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    public static FragmentDirecteurRapport newInstance(){
        FragmentDirecteurRapport fragment = new FragmentDirecteurRapport();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_agent_rapport, container, false);
    ...
    private void initView(View view){
        ...
        floatingActionButton = view.findViewById(R.id.idFloatingActionButtonAgent);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            /*case R.id.idFloatingActionButtonAgent:
                Intent intent = new Intent(getContext(), EditeRapportDirecteur.class);
