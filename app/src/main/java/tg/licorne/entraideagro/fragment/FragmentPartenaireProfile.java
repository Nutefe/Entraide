...
public class FragmentPartenaireProfile extends Fragment {
    ...
    public static FragmentPartenaireProfile newInstance(){
        FragmentPartenaireProfile fragment = new FragmentPartenaireProfile();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_partenaire_profil, container, false);
