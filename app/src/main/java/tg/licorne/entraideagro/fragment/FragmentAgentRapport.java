...
public class FragmentAgentRapport extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    public static FragmentAgentRapport newInstance(){
        FragmentAgentRapport fragment = new FragmentAgentRapport();
        return fragment;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.idFloatingActionButtonAgent:
                Intent intent = new Intent(getContext(), EditeRapportActivity.class);
